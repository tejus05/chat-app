...
const MessageElement = ({message, hasNextMessageFromSameUser, isCurrentUser, chatPartner, sessionImage, chatId}:MessageProps) => {
            ...
            {isEditing && (
              <Form {...form}>
                ...
                <span className="text-[10px] mt-1 text-zinc-400 tracking-tighter">
                  To save, press "Enter". To cancel, press "Esc" or click anywhere.
                </span>
              </Form>
            )}
          </div>
